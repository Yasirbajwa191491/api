...
const Navbar = () => {
  ...
  <div className="container">
    <NavLink className="navbar-brand" to="/ApiWithRedux" style={{fontSize:"15px"}}>Yasir191491</NavLink>
    ...
    <div className="collapse navbar-collapse" id="navbarSupportedContent">
      <ul className="navbar-nav ms-auto mb-2 mb-lg-0">
        <li className="nav-item">
          <NavLink className="nav-link" aria-current="page" to="/ApiWithRedux" style={{fontSize:"15px"}}>Home</NavLink>
        </li>
        <li className="nav-item">
